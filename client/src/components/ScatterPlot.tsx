...
class Scatter extends React.Component<Props, any>{
    ...
    searchGraph(pointData: ChoosePointData): void {//根据名字搜索包含该节点的网络
        ...
        axios.post(url + '/searchGraphByGraphId', { wd: pointData.id, dataType: dataType, dimensions: dimensions, attrWeight: attrWeight, strWeight: strWeight, attrChecked: checkedArr })
            .then(res => {
                ...
                this.props.parent.addPersonGraph(res.data.data[0]);
            })
    ...
    render(): React.ReactElement {
        ...
        let pointsChoose = choosePoints.map((value: ChoosePointData, index: number) =>
            <circle r="2px" opacity={1} cx={value.x} cy={value.y} key={index} fill="#fff" stroke="#000" strokeWidth="0.5" onClick={this.searchGraph.bind(this, value)}></circle>
        )
        //点击的点，需要匹配的点
            ...
            <div className="scatter">
                ...
                <div className="clusterPanel" style={{ display: this.props.showClusterPanel }}>
                    <div className="searchPanel">
                        <NodeList dimensions={dimensions} url={url} dataType={dataType} attrChecked={attrChecked} attrWeight={attrWeight} strWeight={strWeight} parent={{setPersonGraphs:this.props.parent.setPersonGraphs,addPersonGraph:this.props.parent.addPersonGraph}}></NodeList>
                    </div>
